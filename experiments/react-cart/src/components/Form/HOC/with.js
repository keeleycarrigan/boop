...
withFormConnection(
    class extends PureComponent {
      constructor(props) {
        ...
        this.field = forwardedRef || React.createRef();
        ...
        this.state = merge({}, buildFieldState(formApi, field), { value: initialValue });
      ...
      componentDidUpdate(prevProps) {
        ...
        if (!isEqual(prevDelegate, newDelegate)) {
          this.fieldController.updateDelegate(newDelegate);
        }
      }
